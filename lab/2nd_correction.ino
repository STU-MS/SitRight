...
void setup() {
  ...
  // 输出启动信息
  Serial.println("SitRight Firmware v1.0");
  Serial.print("Loaded - Normal: ");
  Serial.print(calibNormal, 2);
  Serial.print(", Slouch: ");
  Serial.println(calibSlouch, 2);
  Serial.println("Ready. Commands: CMD:SET_NORMAL, CMD:SET_SLOUCH");
}
